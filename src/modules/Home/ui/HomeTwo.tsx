        ...
        <Section.Row>
          ...
          <Section.Column variant='content'>
            <Section.Gap>
              ...
              <Text>DePro позволяет упростить процесс создания приложений, и имеет ряд преимуществ перед конкурентами:</Text>
              <TextGroup>
                <List>
                  <List.Li>
                    <Heading>Любая сложность</Heading>
                    <Section.Indent />
                  ...
                  <List.Li>
                    <Heading>Масштабируемость без ограничений</Heading>
                    <Section.Indent />
                  ...
                  <List.Li>
                    <Heading>Простота и легкий вход</Heading>
                    <Section.Indent />
