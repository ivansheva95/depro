      ...
      <Container>
        <Section.Row>
          ...
          <Section.Column variant='content'>
            <TextGroup>
              <TextAnimated>UX дизайн или пользовательский опыт определяет ЧТО должно делать приложение. От него зависит насколько эффективно и удобно будет работать пользователю с приложением.
